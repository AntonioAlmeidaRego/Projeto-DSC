...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	private void telas(HttpSecurity http) throws Exception {
		...
		.antMatchers("/autor/**").hasRole("ADMINISTRADOR")
		.antMatchers("/categoria/**").hasRole("ADMINISTRADOR")
		.antMatchers("/compra/**").hasRole("ADMINISTRADOR")
		.antMatchers("/editora/**").hasRole("ADMINISTRADOR")
		.antMatchers("/livro/**").permitAll()
		.antMatchers("/pedido/**").permitAll()
		.antMatchers("/promocao/**").hasRole("ADMINISTRADOR")
