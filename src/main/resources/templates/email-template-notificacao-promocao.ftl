...
<table align="center" width="100%" border="0" cellpadding="0"  style="max-width:600px;width:100% !important;font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;font-size:10px;" cellspacing="0">
  ...
  <tr>
    <td class="conteudo-editavel"  height="59" width="50%"  colspan=""  valign="top" style="vertical-align:top;background:#E4E4E2;color:#BF392B;font-size:1.7em;" ><p align="center">Olá ${name}, veja as promoções da livraria DSC</p></td>
  </tr>
  ...
  <tr>
    <td colspan="2">
      <table width="100%" cellpadding="0"  cellspacing="0">
        ...
        <tr style="text-align:center;">
         	 <#list livros as livro>
         	 	<td height="14" class="conteudo-editavel"  style="font-size:14px;color:#000;padding:0px 0;">${livro.preco}</td>
         	 </#list>	
        </tr>
        <tr style="text-align:center;">
